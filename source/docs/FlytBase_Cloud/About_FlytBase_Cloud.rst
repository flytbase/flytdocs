...
Follow the setup link below to try out FlytBase cloud APIs. Try out the cloud APIs on virtual drone first (explained in setup), once you are familiar with the workflow go on to connect real drone.
