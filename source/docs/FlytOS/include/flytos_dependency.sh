...
apt-get install ros-indigo-usb-cam ros-indigo-image-proc ros-indigo-image-transport-plugins ros-indigo-image-transport ros-indigo-rosbridge-suite ros-indigo-control-toolbox ros-indigo-pyros-setup ros-indigo-eigen-conversions
