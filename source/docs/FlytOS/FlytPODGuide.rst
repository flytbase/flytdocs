...
* :ref:`Flashing FlytOS Linux Image <FlytOS_linux_image_flytpod>`  [**Recommended method**]
* :ref:`Installing FlytOS dependencies in your custom image<install_dependencies_flytpod>`

.. _FlytOS_linux_image_flytpod:
...
Visit :ref:`this link <hardware_setup_flytpod>` for details regarding hardware setup.
