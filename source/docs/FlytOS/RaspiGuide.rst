...
* :ref:`Flashing FlytOS Linux Image <FlytOS_linux_image_rpi>` [**Recommended method**]
* :ref:`Installing FlytOS dependencies in your custom image<install_dependencies_rpi>`


.. _FlytOS_linux_image_rpi:

Flashing FlytOS Linux Image
^^^^^^^^^^^^^^^^^^^^^^^^^^^

This section will help you in flashing FlytOS Linux Image on any SD/eMMC card for your Raspberry Pi 3. 
...
.. warning:: Follow this step ONLY if you have chosen to NOT TO flash :ref:`FlytOS Linux Image <FlytOS_linux_image_rpi>`.
...
Visit :ref:`this link <hardware_setup_rpi>` for details regarding hardware setup.
