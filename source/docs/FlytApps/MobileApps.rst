...
a. Here you are required to download the Flyt-Android-SDK based on Android Studio from `here <https://s3-us-west-2.amazonaws.com/flytos/FlytOS_debianpackage/FlytSimV0.3-1.zip>`_ and build your app using it.
